...
import 'package:agent_mobile_app/pages/desc_product/pulsa/pulsa_list.dart';
...
class PulsaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: _inputNumber == null
            ? ReusableWidget.infoPayment(
                context: context, pageRoute: PulsaPage())
            : null);
  }
}
